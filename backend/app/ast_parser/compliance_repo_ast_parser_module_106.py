"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — HCL2 & CloudFormation Abstract Syntax Tree Parser (Unit 106)
...
class ASTParser_106:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_106"):
        ...
        self.active_state_cache: Dict[str, ASTParserState_106] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> ASTParserState_106:
        self.invocations += 1
