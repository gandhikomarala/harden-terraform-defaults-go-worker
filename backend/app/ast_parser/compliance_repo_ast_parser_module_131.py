"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — HCL2 & CloudFormation Abstract Syntax Tree Parser (Unit 131)
...
class ASTParser_131:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_131"):
        ...
        self.active_state_cache: Dict[str, ASTParserState_131] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> ASTParserState_131:
        self.invocations += 1
