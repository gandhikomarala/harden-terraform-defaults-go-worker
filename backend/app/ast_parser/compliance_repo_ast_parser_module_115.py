"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — HCL2 & CloudFormation Abstract Syntax Tree Parser (Unit 115)
...
class ASTParser_115:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_115"):
        ...
        self.active_state_cache: Dict[str, ASTParserState_115] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> ASTParserState_115:
        self.invocations += 1
