"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — IAM Privilege Escalation & Least-Privilege Scanner (Unit 036)
...
class IAMAnalyzer_036:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_036"):
        ...
        self.active_state_cache: Dict[str, IAMAnalyzerState_036] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> IAMAnalyzerState_036:
        self.invocations += 1
