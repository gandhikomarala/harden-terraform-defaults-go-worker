"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — IAM Privilege Escalation & Least-Privilege Scanner (Unit 136)
...
class IAMAnalyzer_136:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_136"):
        ...
        self.active_state_cache: Dict[str, IAMAnalyzerState_136] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> IAMAnalyzerState_136:
        self.invocations += 1
