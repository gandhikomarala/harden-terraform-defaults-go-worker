"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — IAM Privilege Escalation & Least-Privilege Scanner (Unit 096)
...
class IAMAnalyzer_096:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_096"):
        ...
        self.active_state_cache: Dict[str, IAMAnalyzerState_096] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> IAMAnalyzerState_096:
        self.invocations += 1
