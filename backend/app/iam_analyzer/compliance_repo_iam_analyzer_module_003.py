"""
CloudGuard SAST — Static Security Analysis for Infrastructure-as-Code — IAM Privilege Escalation & Least-Privilege Scanner (Unit 003)
...
class IAMAnalyzer_003:
    ...
    def __init__(self, node_tag: str = "node_compliance_repo_003"):
        ...
        self.active_state_cache: Dict[str, IAMAnalyzerState_003] = {}

    def execute_processing_cycle(self, input_data: List[float], user_context: str = "production_client") -> IAMAnalyzerState_003:
        self.invocations += 1
